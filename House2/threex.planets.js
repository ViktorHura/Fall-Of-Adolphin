...
THREEx.Planets.createSun	= function(){
	...
	var texture	= THREE.ImageUtils.loadTexture('/../FOA/images/sunmap.jpg')
...
THREEx.Planets.createEarth	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map		: THREE.ImageUtils.loadTexture('/../FOA/images/earthmap1k.jpg'),
		bumpMap		: THREE.ImageUtils.loadTexture('/../FOA/images/earthbump1k.jpg'),
		bumpScale	: 0.05,
		specularMap	: THREE.ImageUtils.loadTexture('/../FOA/images/earthspec1k.jpg'),
...
THREEx.Planets.createEarthCloud	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src	= '/../FOA/images/earthcloudmaptrans.jpg';
	}, false);
	imageMap.src	= '/../FOA/images/earthcloudmap.jpg';
